...
class PipelineState(TypedDict, total=False):
    ...
    document_path: str              # Optional: path to PDF/DOC for text extraction
    document_bytes: bytes           # Optional: PDF/DOC bytes for extraction
    ...
    notary_validation: ValidationResult
